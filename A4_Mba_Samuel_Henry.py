...
#STUDENTS - MBA SAMUEL HENRY & Basharkhah Tiseh Samim
#ASSIGNMENT 4
...
Entrez.email = "me21m020@technikum-wien.at"
...
with open('A4_SIRT7_Koranteng_Felix.csv', 'w', newline='') as file:
    ...
    with open('sirt7.faa', 'w') as fasta:
        for gene_id in record["IdList"]:
            ...
            elif (gene_entry.annotations["organism"][:5] == "Blomi" or gene_entry.annotations["organism"][
                                                                       :5] == "Tachy" or gene_entry.annotations[
                                                                                             "organism"][
                                                                                         :5] == "Mugil" or
                  gene_entry.annotations["organism"][:5] == "Hippo" or gene_entry.annotations["organism"][
                                                                       :5] == "Girar" or gene_entry.annotations[
                                                                                             "organism"][
                                                                                         :5] == "Scoph" or
                  gene_entry.annotations["organism"][:5] == "Ictal" or gene_entry.annotations["organism"][
                                                                       :5] == "Marmo" or gene_entry.annotations[
                                                                                             "organism"][
                                                                                         :5] == "Micro" or
                  gene_entry.annotations["organism"][:5] == "Meles" or gene_entry.annotations["organism"][
                                                                       :5] == "Ursus"):
                continue
            ...
            # Storing Basic Info
            writer.writerow(
                [gene_entry.id, gene_entry.description, gene_entry.annotations["organism"], len(gene_entry.seq)])

input_file = '/home/henrysamuelmba/Desktop/Education/MME/Semester2/Bioinformatics/phylogenetics/sirt7.faa'
